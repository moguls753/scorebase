...
CREATE TRIGGER scores_instruments_fts_au AFTER UPDATE ON scores
      ...
      END;
CREATE INDEX "index_scores_on_rag_failure_reason_partial" ON "scores" ("rag_failure_reason") WHERE rag_failure_reason IS NOT NULL /*application='Scorebase'*/;
