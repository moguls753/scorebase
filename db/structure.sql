...
CREATE INDEX "index_scores_on_work_key" ON "scores" ("work_key") /*application='Scorebase'*/;
CREATE INDEX "index_scores_on_duplicate_of_id" ON "scores" ("duplicate_of_id") /*application='Scorebase'*/;
CREATE UNIQUE INDEX "index_scores_on_source_and_external_id" ON "scores" ("source", "external_id") /*application='Scorebase'*/;
...
CREATE TRIGGER scores_instruments_fts_au AFTER UPDATE ON scores
      ...
      END;
CREATE TABLE IF NOT EXISTS "score_stretta_matches" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "score_id" integer NOT NULL, "stretta_score_id" integer NOT NULL, "rank" integer NOT NULL, "suppressed" boolean DEFAULT FALSE NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_632a4ef35b"
FOREIGN KEY ("score_id")
  REFERENCES "scores" ("id")
 ON DELETE CASCADE, CONSTRAINT "fk_rails_2cffba6c87"
FOREIGN KEY ("stretta_score_id")
  REFERENCES "scores" ("id")
 ON DELETE CASCADE);
CREATE INDEX "index_score_stretta_matches_on_score_id" ON "score_stretta_matches" ("score_id") /*application='Scorebase'*/;
CREATE UNIQUE INDEX "index_score_stretta_matches_on_score_id_and_rank" ON "score_stretta_matches" ("score_id", "rank") WHERE suppressed = FALSE /*application='Scorebase'*/;
CREATE UNIQUE INDEX "index_score_stretta_matches_on_score_id_and_stretta_score_id" ON "score_stretta_matches" ("score_id", "stretta_score_id") /*application='Scorebase'*/;
CREATE INDEX "index_score_stretta_matches_on_stretta_score_id" ON "score_stretta_matches" ("stretta_score_id") /*application='Scorebase'*/;
